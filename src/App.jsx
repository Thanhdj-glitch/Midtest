...
const movieData = [
 // {
    ...
    //     "image": "./images/weather_with_you.png",
    //     "episode": "01"
    // },
    {
      "id": "2",
  ...
  },
  {
      ...
      "image": "./boruto-naruto-next-generations 1.png",
      "episode": "250"
  },
  {
      "id": "4",
  ...
  return (
    <>
      <div className="app-container">
        ...
        <p className="content-p">what are you gonna watch today ?</p>
        <div className="carousel">
          <img src="./spy_carousel 1.png" alt="" />
          <div className="carousel-description">
            <h4 className="carousel-title">Weather With You</h4>
        ...
        {selectedAnime && (
          <div className="explore-info" style={{ textAlign: 'center' }}>
            <img src={selectedAnime.image} alt={selectedAnime.movieName} className="selected-anime-image" style={{ width: '300px', height: 'auto' }} />
